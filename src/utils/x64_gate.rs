...
use crate::{MemoryError, YapiError, Result};
...
const X64_CALL: &[u8] = &[
    ,
];
...
fn resolve_local_ntdll_64_export(name: &[u8]) -> Option<u64> {
    ...
    let pid = unsafe { windows::Win32::System::Threading::GetProcessId(
    ...
    let arch = crate::YapiArch::new(crate::Architecture::X64, crate::Architecture::X64, crate::Architecture::X64);
...
pub unsafe fn x64_call(func: u64, args: &[u64]) -> Result<u64> {
    assert!(args.len() <= 10, "heaven's gate supports up to 10 arguments");
    ...
    unsafe {
        match args.len() {
            ...
            6 => Ok(gate(func, 6, args[0], args[1], args[2], args[3], args[4], args[5])),
            7 => Ok(gate(func, 7, args[0], args[1], args[2], args[3], args[4], args[5], args[6])),
            8 => Ok(gate(
...
pub unsafe fn create_remote_thread_64_suspended(
    ...
    let process = unsafe { super::memory_reader::ensure_real_handle(process) };
